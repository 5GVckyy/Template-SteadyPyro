...
from SteadyProject import LOGGER
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("SteadyProject").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("SteadyProject").info(f"Invalid Git Command")
        ...
        LOGGER("SteadyProject").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("SteadyProject").info(f"Heroku App Configured")
